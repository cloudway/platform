...
$i++;
$cfg['Servers'][$i]['host']          = getenv('CLOUDWAY_MYSQL_DB_HOST'); // MySQL hostname or IP address
$cfg['Servers'][$i]['port']          = getenv('CLOUDWAY_MYSQL_DB_PORT'); // MySQL port - leave blank for default port
$cfg['Servers'][$i]['socket']        = getenv('CLOUDWAY_MYSQL_DB_SOCKET'); // Path to the socket - leave blank for default socket
 ...
 */
$cfg['UploadDir'] = getenv('CLOUDWAY_PHPMYADMIN_DIR') . '/upload';
$cfg['SaveDir']   = getenv('CLOUDWAY_PHPMYADMIN_DIR') . '/save';
