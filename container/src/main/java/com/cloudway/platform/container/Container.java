...
public interface Container
{
    ...
    static Container fromId(String id)
        ...
        return DefaultContainer.fromId(id);
    }

    /**
     * Create a container.
     */
    static Container create(String id, String name, String namespace, String capacity)
        throws IOException {
        return DefaultContainer.create(id, name, namespace, capacity);
    }
    ...
    static boolean exists(String id) {
        return DefaultContainer.exists(id);
    }
     ...
     */
    static Stream<Container> all() {
        return ids().stream().map(Container::fromId);
    }
     ...
     */
    List<Plugin.Endpoint> getEndpoints();
